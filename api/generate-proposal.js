      ...
      sections: [{
        ...
        children: [
          ...
          new Paragraph({ spacing: { before: 200 }, alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Primary Point of Contact: ${personnel.contact.name}`, size: 20, bold: true })]
          }),
          new Paragraph({ alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Email: ${personnel.contact.email}  |  Phone: ${personnel.contact.phone}`, size: 20, color: "2E86AB" })]
          }),
          new Paragraph({ spacing: { before: 200 }, alignment: AlignmentType.CENTER,
