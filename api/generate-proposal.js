...
export default async function handler(req, res) {
  ...
  try {
    ...
    const heading1 = (text) => new Paragraph({
      ...
      children: [new TextRun({ text, bold: true, size: 32, color: "1B4F72" })]
    });
    ...
    const doc = new Document({
      ...
      sections: [{
        ...
        children: [
          ...
          new Paragraph({
            alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: "TECHNICAL AND MANAGEMENT PROPOSAL", bold: true, size: 44, color: "1B4F72" })]
          }),
          ...
          new Paragraph({ spacing: { before: 100 }, alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Agency: ${agency}`, size: 24, color: "666666" })]
          }),
          new Paragraph({ spacing: { before: 800 }, alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: "Submitted by:", size: 22, color: "666666" })]
          }),
          new Paragraph({ alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: "SINGH AUTOMATION LLC", bold: true, size: 32, color: "1B4F72" })]
          }),
          new Paragraph({ alignment: AlignmentType.CENTER, spacing: { after: 100 },
            children: [new TextRun({ text: company.hq, size: 22 })]
          }),
            ...
            rows: [
              new TableRow({ children: [
                new TableCell({ borders: cellBorders, shading: headerShading, width: { size: 4680, type: WidthType.DXA },
                  children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "CAGE Code", bold: true, color: "FFFFFF", size: 20 })] })] }),
                new TableCell({ borders: cellBorders, shading: headerShading, width: { size: 4680, type: WidthType.DXA },
                  children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "UEI", bold: true, color: "FFFFFF", size: 20 })] })] })
              ]}),
              new TableRow({ children: [
                new TableCell({ borders: cellBorders, width: { size: 4680, type: WidthType.DXA },
                  children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: company.cage, size: 24, bold: true })] })] }),
                new TableCell({ borders: cellBorders, width: { size: 4680, type: WidthType.DXA },
                  children: [new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: company.uei, size: 24, bold: true })] })] })
              ]})
            ]
          }),
          
          new Paragraph({ spacing: { before: 400 }, alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Contact: ${company.email}`, size: 20 })]
          }),
          new Paragraph({ alignment: AlignmentType.CENTER,
            children: [new TextRun({ text: `Submission Date: ${new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}`, size: 20 })]
          }),
          ...
          new Paragraph({
            spacing: { after: 200 },
            children: [
              new TextRun({ text: `Singh Automation LLC is pleased to submit this proposal in response to Solicitation ${solicitation} for ${title}. `, size: 22 }),
              new TextRun({ text: "As a FANUC Authorized System Integrator and Universal Robots Certified Systems Partner", bold: true, size: 22 }),
              new TextRun({ text: ", Singh Automation offers a proven, technically excellent solution backed by direct OEM relationships and a highly experienced team.", size: 22 })
            ]
          }),
          
          heading2("1.1 Understanding of Requirements"),
          para(`${agency} requires ${description || 'automation and robotics solutions to modernize operations and improve efficiency'}. Singh Automation understands the critical need for reliable, high-performance automated systems that integrate seamlessly with existing operations while minimizing disruption during installation.`),
          
          heading2("1.2 Proposed Solution Overview"),
          para("Singh Automation will deliver a turnkey robotic solution featuring FANUC robots with integrated controls, safety systems, and comprehensive documentation. Our solution includes complete PLC integration, operator training, and ongoing support."),
          
          heading2("1.3 Why Singh Automation"),
          bulletPoint("FANUC Authorized System Integrator with direct OEM support and warranty coverage"),
          bulletPoint("Universal Robots Certified Systems Partner for collaborative applications"),
          bulletPoint("Michigan headquarters with rapid Midwest response capability"),
          bulletPoint("Small business agility with competitive pricing"),
          bulletPoint("In-house controls, mechanical, and vision system expertise"),
          
          heading2("1.4 Commitment Statement"),
          para("Singh Automation is fully committed to delivering a high-quality automation solution on schedule and within budget. Our team is prepared to begin work immediately upon contract award."),
