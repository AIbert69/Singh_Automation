...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Check for format parameter - 'json' for preview, 'docx' for download
        const format = body.format || req.query.format || 'docx';
        ...
        // If JSON format requested (for preview), return markdown text
        if (format === 'json') {
            const today = new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' });
            const value = opportunity.value || 350000;
...
Singh Automation is pleased to submit this proposal in response to ${opportunity.agency}'s requirement for ${opportunity.title}.

As an authorized FANUC and Universal Robots (UR) system integrator with extensive experience in manufacturing automation, Singh Automation is well positioned to deliver a turnkey solution that meets or exceeds all technical and performance requirements.

The estimated value of this project is $${value.toLocaleString()}, inclusive of engineering, equipment, integration, installation, and training.
...
### 2.1 System Design
- **Robotics:** FANUC 6-axis industrial robot and/or Universal Robots collaborative robot
- **Vision & Sensing:** AI-enabled machine vision for part detection and quality inspection
- **Controls & HMI:** Allen-Bradley or Siemens PLC platform
- **Cell Infrastructure:** Custom fixtures, perimeter guarding, safety devices

### 2.2 Implementation Phases
1. **Discovery & Design (Weeks 1–4)**
2. **Fabrication & Build (Weeks 5–10)**
3. **Integration & FAT (Weeks 11–14)**
4. **Installation & SAT (Weeks 15–18)**
5. **Support & Optimization (Post-Installation)**

---

## 3. Management Approach

- Formal project management framework aligned with PMI best practices
- Weekly status reports and milestone reviews
- Dedicated Project Manager, Robotics Engineer, Controls Engineer, Vision Specialist
...
| Conveyor Automation – F&B | $350,000 | 50% throughput increase |
...
- **CAGE:** 86VF7
- **NAICS:** 333249, 333922, 541330, 541512, 541715, 238210
- **Certifications:** FANUC ASI, UR Certified, MBE, WBENC
...
We appreciate the opportunity to propose on this project.`;
        ...
        // Otherwise generate proper DOCX
