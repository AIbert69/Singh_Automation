...
export const config = {
    ...
    scoring: {
        ...
        /** Minimum score for GO recommendation (high confidence, pursue) */
        goThreshold: 70,

        /** Minimum score for EVALUATE recommendation (needs capacity decision) */
        evaluateThreshold: 50,

        /** Below this = PASS (not worth time) */
        passThreshold: 50,
