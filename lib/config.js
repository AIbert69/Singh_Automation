...
export const config = {
    ...
    companyProfile: {
        ...
        naicsCodes: [
            // Singh Automation - Robotics & Engineering (PRIMARY)
            ...
            '327992', // Thermal Insulation Mfg (STS) - ADD TO SAM
            ...
            '336413', // Aircraft Parts Mfg (STS) - ADD TO SAM
            // Singh Vision Systems - Molding & Plastics
            '333511', // Industrial Mold Manufacturing
            '326199', // All Other Plastics Product Manufacturing (Carma)
            ...
            // Defense/Navy (NAVSEA work)
            '336611', // Ship Building & Repair - ADD TO SAM
        ],

        /** PSC (Product Service Codes) to watch */
        pscCodes: [
            'R425',  // Engineering & Technical Services
            'AE11',  // R&D - Manufacturing Technology
            'AC24',  // R&D - Defense Systems & Equipment
            'J036',  // Maintenance/Repair - Special Industry Machinery
            'L032',  // Technical Support - Metalworking Machinery
            'D302',  // IT and Telecom - Systems Development
        ],

        /** Target agencies with higher win probability */
        targetAgencies: [
        ...
        keywords: [
            ...
            'system integrator', 'robotic arm', 'cobot', 'assembly line',
            // AI Vision & Data Centers
            'computer vision', 'inspection', 'data center', 'cabling',
    ...
    contractLimits: {
        /** Micro-purchase threshold (fastest acquisition) */
        microPurchase: 25000,
        /** Simplified acquisition lower bound (PRIMARY TARGET) */
        simplifiedMin: 25000,
        /** Simplified acquisition upper bound */
        simplifiedMax: 250000,
        /** Max contract value as prime */
        maxPrime: 500000,
        /** Max full & open competition (low win probability above this) */
        maxFullAndOpen: 1000000,
        /** Sweet spot range */
        sweetSpotMin: 25000,
        sweetSpotMax: 150000,
    },
